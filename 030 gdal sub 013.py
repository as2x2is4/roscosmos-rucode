...
def run_change_det(infile):
    ...
    for iBand in range(0, indataset.RasterCount):
        ...
        band_cloud_mask = (outband_arr >= 255*0.95)*255
    ...
    band_grad_mask = (band_grad_mask / 4.0).astype('uint8')
    ...
    band_color_dif = (band_color_dif / 4.0).astype('uint8')
